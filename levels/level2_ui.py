...
class Level2UI:
    ...
    def create_virtual_keyboard(self):
        self.keyboard_frame = tk.Frame(self.level_frame, bg="#F0F0F0")
        self.keyboard_frame.place(relx=0.5, rely=0.75, anchor="center")
        for i, word in enumerate(self.words):
            btn = tk.Button(self.keyboard_frame, text=word, font=("Arial", 14), bg="lightgray", command=lambda w=word: self.insert_text(w))
